...
namespace AssetInventory
{
    public sealed class DependenciesUI : EditorWindow
    {
        ...
        public void OnGUI()
        {
            EditorGUILayout.LabelField($"{_info.Dependencies.Count} dependencies of '{_info.FileName}' in asset '{_info.GetDisplayName()}' ({EditorUtility.FormatBytes(_info.Size)})", EditorStyles.wordWrappedLabel);
