...
namespace AssetInventory
{
    public abstract class BasicEditorUI : EditorWindow
    {
        ...
        {
            AssetInventorySettings c = AssetInventory.Config;
            bool isAdvanced = c.advancedUI.Contains(key);

            return !isAdvanced || ShowAdvanced() || AssetInventory.UICustomizationMode;
        }
        ...
        protected static void UIBlock(string key, Action content, bool alwaysShow = false, bool horizontal = false, bool expand = true)
        {
            ...
            if (AssetInventory.UICustomizationMode)
            {
        ...
        // shortcut
        protected static bool ShowAdvanced() => AssetInventory.ShowAdvanced();
    }
}
