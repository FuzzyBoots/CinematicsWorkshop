...
namespace AssetInventory
{
    internal sealed class AssetTreeViewControl : TreeViewWithTreeModel<AssetInfo>
    {
        ...
        private void CellGUI(Rect cellRect, TreeViewItem<AssetInfo> item, Columns column, ref RowGUIArgs args)
        {
            ...
            switch (column)
            {
                ...
                case Columns.Downloaded:
                    if (item.Data.Downloaded) RenderIcon(rect, checkmarkIcon);
                    break;
                ...
                case Columns.Popularity:
                    EditorGUI.LabelField(cellRect, $"{item.Data.Hotness:N1}");
                    break;
                ...
                case Columns.RatingCount:
                    EditorGUI.LabelField(cellRect, item.Data.RatingCount.ToString());
                    break;
                ...
                case Columns.Version:
                    ...
                    {
                        if (AssetInventory.ShowAdvanced() && GUI.Button(rect, "enter manually"))
                        {
        ...
        public static MultiColumnHeaderState CreateDefaultMultiColumnHeaderState(float treeViewWidth)
        {
            ...
            columns[(int)Columns.Popularity] = GetTextColumn("Hotness");
