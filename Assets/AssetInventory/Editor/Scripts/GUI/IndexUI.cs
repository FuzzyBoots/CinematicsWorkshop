    ...
    public partial class IndexUI : BasicEditorUI
    {
        ...
        private void ReloadLookups(bool force = true)
        {
            ...
            _expertSearchFields = new[]
            {
                ...
                "Asset/SafePublisher", "Asset/Slug", "Asset/SupportedUnityVersions", "Asset/UpdateStrategy", "Asset/UploadId", "Asset/UseAI", "Asset/Version",
        ...
        private bool DrawToolbar()
        {
            ...
            UILine("toolbar.togglecustomization", () =>
            {
                ...
                if (AssetInventory.UICustomizationMode) GUI.color = Color.green;
                if (GUILayout.Button(EditorGUIUtility.IconContent("d_CustomTool", "|Toggle UI Customization"), EditorStyles.label))
                {
                    AssetInventory.UICustomizationMode = !AssetInventory.UICustomizationMode;
                }
                GUI.color = curCol;
            });
        ...
        {
            await AssetInventory.FetchAssetsDetails(forceUpdate, assetId, assetId > 0, skipEvents);
